...
# -*- coding: utf-8 -*-
"""
Created on Sun Nov 12 09:26:47 2017
...
#print(range(missCLassError))
#print(len(missCLassError))
#missCLassError2=[missCLassError[i]*1000.0 for i in range(missCLassError)]
